...
/**
 * Created by shesong on 2017/11/23.
 */

public class SunlandSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
         ...
         * @param context
         */
        public SunlandSwipeRefreshLayout(Context context) {
            this(context, null);
        }
         ...
         * @param attrs
         */
        public SunlandSwipeRefreshLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
        ...
        private void createProgressView() {
            ...
            mProgress = new SunlandProgressDrawable(getContext(), this);
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP: {
                    ...
                    if (mIsBeingDragged) {
                        final float y = ev.getY(pointerIndex);
                        if(y - mInitialMotionY>300)
                            mTarget.animate().translationY(300).setDuration(200).start();
                        final float overscrollTop = (y - mInitialMotionY) * DRAG_RATE;
                        mIsBeingDragged = false;
